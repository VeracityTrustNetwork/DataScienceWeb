...
export const Test1 = () => {
  ...
  return (
    <article id="block-exercise-1" className="notion-root">
        ...
        <p className="notion-text__content">
          <span className="notion-semantic-string">
            <span>
              ...
              the data is in the correct format or data type and does not contain
      ...
      <h1 id="block-efa42409b4de40c69f8b0754c6da63b1" className="notion-heading"><span className="notion-heading__anchor" id="efa42409b4de40c69f8b0754c6da63b1"></span><span className="notion-semantic-string"><span>💭&nbsp;Firstly open</span><span><a href="https://colab.research.google.com/" className="notion-link link" target="_blank" rel="noopener noreferrer"> Google Colab</a></span><span> and import below dependencies </span></span></h1>
      <div
  id="block-63b75136c4eb43f4b024e0ad6c99176e"
  className="notion-code no-wrap"
>
  <button className="notion-code__copy-button" onClick={() => { copyToClipboard(1, 3) }}>
  ...
  <pre className="language-python" tabIndex={0}>
    <code className="language-python">
      ...
      <span className="token keyword">import</span> numpy{" "}
      <span className="token keyword">as</span> np{"\n"}
      <span className="token keyword">import</span> matplotlib
      <span className="token punctuation">.</span>pyplot{" "}
      <span className="token keyword">as</span> plt
    </code>
  </pre>
  <figcaption className="notion-caption">
    <span className="notion-semantic-string" />
      ...
      <div
        ...
        className="notion-code no-wrap custom"
      >
      ...
      <h1 id="block-dfb5d4c20b3845e1938decbdcbe658b5" className="notion-heading">
        ...
        <span className="notion-semantic-string">
          ...
          <span>
            <strong>
              1.2 Iterate through the data frame using a "for loop" and print the data
          type of the{" "}
            </strong>
          </span>
          <span>
      ...
      >
        ...
        <div className="notion-callout__content">
          <span className="notion-semantic-string">
            <span>
              Hint: documentation for 'for loop' can be found {''}
        </span><span>
              <Link
        ...
        >
          ...
          <span className="notion-semantic-string">
            <span>
              ...
              Science project. During this phase, we aim to visualise certain
  ...
  <article id="block-exercise-3" className="notion-root">
          ...
          <p className="notion-text__content">
            <span className="notion-semantic-string">
              <span>
                ...
                programmatically encoding behaviours we use top differentiate bots
    ...
    <h1 id="block-76e89b215fe14efba01f64bb41b4317f" className="notion-heading">
      ...
      <span className="notion-semantic-string">
        ...
        <span>
          <strong>
            .2 Iterate through the dataframe and assign a flag value of 1(as an integer)  to the
    ...
    <ul className="notion-bulleted-list">
      ...
      >
        <span className="notion-semantic-string">
          <span>If 1 flag columns is flagged, assign a value of 25</span>
        </span>
      </li>
      <li
